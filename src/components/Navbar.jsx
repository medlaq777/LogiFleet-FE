...
const Navbar = ({ onMenuClick }) => {
    ...
    return (
        <header className="h-20 bg-[#0B0E1A] border-b border-zinc-800 sticky top-0 z-50 flex items-center justify-between px-6 md:px-8">
            <div className="flex items-center">
                <button
                    onClick={onMenuClick}
                    className="md:hidden p-2 text-zinc-400 hover:text-white hover:bg-zinc-800 rounded-lg transition-colors mr-4"
                >
            ...
            <div className="flex items-center gap-4">
                ...
                <button className="p-2 text-zinc-400 hover:text-white hover:bg-zinc-800 rounded-lg transition-colors group">
