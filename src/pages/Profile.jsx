...
function ProfileField({ icon, label, value }) {
    return (
        <div className="flex items-center p-4 bg-[#11141F] rounded-xl border border-white/5 hover:border-white/10 transition-all duration-200 h-full">
            <div className="w-10 h-10 rounded-full bg-primary-600/10 flex items-center justify-center mr-4">
    ...
    return (
        <div className="mb-4">
            ...
            <input
                ...
                value={value}
                onChange={onChange}
                className="w-full bg-[#11141F] border border-zinc-800 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-primary-500 focus:ring-1 focus:ring-primary-500 transition-colors"
            />
        </div>
    );
}
...
const Profile = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-[#1A1F2E] border border-zinc-800 rounded-xl p-8 md:p-12 relative overflow-hidden">
                        ...
                        {isEditing ? (
                            ...
                            <form onSubmit={handleSubmit} className="w-full">
                                ...
                                <div className="flex items-center gap-3 mt-6">
                                    <button
                                        type="submit"
                                        className="px-6 py-2.5 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-xl transition-colors flex items-center gap-2"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="px-6 py-2.5 bg-zinc-800 hover:bg-zinc-700 text-white font-semibold rounded-xl border border-zinc-700 transition-colors flex items-center gap-2"
                                    >
